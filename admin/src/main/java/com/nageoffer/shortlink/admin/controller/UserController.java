...
public class UserController {
     ...
     * @return
     */
    @PostMapping("/api/short-link/v1/actual/user")
     ...
     * @return
     */
    @PutMapping("/api/short-link/v1/actual/user")
     ...
     * @return
     */
    @PostMapping("/api/short-link/v1/actual/user/login")
     ...
     * @return
     */
    @GetMapping("/api/short-link/v1/actual/user/check-login")
     ...
     * @return
     */
    @DeleteMapping("/api/short-link/v1/actual/user/logout")
