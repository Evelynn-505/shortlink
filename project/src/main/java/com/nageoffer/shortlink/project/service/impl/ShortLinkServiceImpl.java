...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    public ShortLinkCreateRespDTO createShortLink(ShortLinkCreateReqDTO requestParam) {
        ...
        stringRedisTemplate.opsForValue().set(
                ...
                LinkUtil.getLinkCacheValidaTime(requestParam.getValidDate()),
    ...
    public void restoreUrl(String shortUri, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            stringRedisTemplate.opsForValue().set(
                    ...
                    LinkUtil.getLinkCacheValidaTime(shortLinkDO.getValidDate()),
                    TimeUnit.MILLISECONDS);
            ShortLinkStatsRecordDTO statsRecord = buildLinkStatsRecordAndSetUser(fullShortUrl, request, response);
    ...
    public void shortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        ...
        try {
            ...
            localeParam.put("ip", statsRecord.getRemoteAddr());
            ...
            if (StrUtil.isNotBlank(infocode) && StrUtil.equals(infocode, "10000")) {
                ...
                linkLocaleStatsDO = LinkLocaleStatsDO.builder()
                        ...
                        .date(new Date())
                        .build();
                localeStatsMapper.shortLinkLocaleState(linkLocaleStatsDO);
            }
            LinkOsStatsDO linkOsStatsDO = LinkOsStatsDO.builder()
